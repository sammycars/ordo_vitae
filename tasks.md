...
- [x] **2.6** Verify schema agreement — confirm `docs/schema.sql`, actual Supabase tables, and the code config layer are in exact agreement. **Andy's gate:** Andybot reviews and signs off before Phase 3 begins.
